package com.example.springhello.testexample;

import com.example.springhello.rest.restdocs.RestDocsMemberController;
...
public class RestDocsMemberControllerTest {
    ...
    @ContextConfiguration(classes = com.example.springhello.rest.restdocs.RestDocsApplication.class)
